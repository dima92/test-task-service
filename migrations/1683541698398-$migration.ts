...
export class $migration1683541698398 implements MigrationInterface {
  name = ' $migration1683541698398';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_roles" ("id" BIGSERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "type" character varying NOT NULL, "name" character varying NOT NULL, "permissions" text array NOT NULL, CONSTRAINT "PK_8acd5cf26ebd158416f477de799" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_89d297076e5b7c048389ff0bd4" ON "user_roles" ("type") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4a77d431a6b2ac981c342b13c9" ON "user_roles" ("name") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0e62503a7a58129eb1c1071bd5" ON "users" ("role_type") `,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1" FOREIGN KEY ("role_id") REFERENCES "user_roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0e62503a7a58129eb1c1071bd5"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4a77d431a6b2ac981c342b13c9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_89d297076e5b7c048389ff0bd4"`,
    );
